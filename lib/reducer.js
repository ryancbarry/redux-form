...
var behaviors = (_behaviors = {}, _behaviors[_actionTypes.ADD_ARRAY_VALUE] = function (state, _ref) {
  ...
  return (0, _write2.default)(path, arrayCopy, stateCopy);
}, _behaviors[_actionTypes.ARRAY_MOVE] = function (state, _ref12) {
  var path = _ref12.path;
  var indexA = _ref12.indexA;
  var indexB = _ref12.indexB;
  ...
  var stateCopy = _extends({}, state);
  var arrayCopy = arrayMove(array, indexA, indexB);
  return (0, _write2.default)(path, arrayCopy, stateCopy);
}, _behaviors[_actionTypes.TOUCH] = function (state, _ref13) {
...
}, _behaviors[_actionTypes.UNTOUCH] = function (state, _ref14) {
...
function arrayMove(array, old_index, new_index) {
  ...
  if (new_index >= arrayCopy.length) {
    var k = new_index - arrayCopy.length;
    while (k-- + 1) {
